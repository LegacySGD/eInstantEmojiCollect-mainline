...
public class EmojiCollectCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(EmojiCollectCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/EmotiCollectIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/EmotiCollectIW/InitOutcome.xml").getDocumentElement();
